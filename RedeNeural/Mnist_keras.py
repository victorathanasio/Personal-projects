...
model = Sequential()
model.add(Conv2D(16, input_shape=(28,28,1),kernel_size=4,activation='relu'))
...
plt.rcParams['figure.figsize'] = (42,140)

figure_evaluation = plt.figure()

#plot 9 correct predictions
# for i, correct in enumerate(correct_indices[:36]):
